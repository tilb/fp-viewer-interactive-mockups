...
var pathToImages = '/img2/calendario/';	// Relative to your HTML file
...
{	if (MSIE)	iframeObj2.style.display = 'none';}
//// fix for EI frame problem on time dropdowns 09/30/2006
...
function pickDate(e,inputDay)
{
	...
	if(returnFormat){
		...
		if(returnDateTo.getAttribute("onchange")){
...
function initCalendar()
{
	if(MSIE){
		...
		iframeObj2.src = '/includes/blank.html'; 
		iframeObj.src = '/includes/blank.html'; 
